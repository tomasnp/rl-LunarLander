...
class Config:
    ...
    # DQN hyperparams (alignés notebook)
    gamma: float = 0.99
...
class DQNAgent:
    ...
    def replay(self) -> float | None:
        ...
        # Décroissance epsilon (comme le notebook)
...
def train(cfg: Config) -> dict:
    ...
    try:
        ...
        print(f"Checkpoint -> {Path(cfg.save_dir) / cfg.save_name}")
        ...
        # Save checkpoint (même nom que notebook)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="DQN LunarLander (simple, style notebook)")
